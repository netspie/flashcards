...
namespace Flashcards.WebApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250517141943_AddConceptTemplates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flashcards.WebApp.Features.ConceptTemplates.ConceptTemplate", b =>
                {
                    ...
                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_concept_templates_project_id");

                    b.ToTable("concept_templates", (string)null);
                });

            modelBuilder.Entity("Flashcards.WebApp.Features.Projects.Project", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId", "IsArchived")
                        .HasDatabaseName("ix_projects_user_id_is_archived");

                    b.ToTable("projects", (string)null);
                });

            modelBuilder.Entity("Flashcards.WebApp.Features.Tags.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Flashcards.WebApp.Features.Account.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Flashcards.WebApp.Features.ConceptTemplates.ConceptTemplate", b =>
                {
                    b.HasOne("Flashcards.WebApp.Features.Projects.Project", null)
                        .WithMany()
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_concept_templates_projects_project_id");
                    ...
                    b.OwnsMany("Flashcards.WebApp.Features.ConceptTemplates.ConceptTemplate+Property", "Properties", b1 =>
                        {
                            ...
                            b1.HasKey("concept_template_id", "Name")
            ...
            modelBuilder.Entity("Flashcards.WebApp.Features.Projects.Project", b =>
                {
                    b.HasOne("Flashcards.WebApp.Features.Account.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Flashcards.WebApp.Features.Tags.Tag", b =>
                {
                    b.HasOne("Flashcards.WebApp.Features.Tags.Tag", null)
                        .WithMany()
